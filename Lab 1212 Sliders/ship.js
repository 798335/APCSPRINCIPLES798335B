...
update(){
  ...
  this.acc.normalize();
  this.acc.mult(sliderAttraction.value()/10);//multiplys the ships attraction by the value of the slider

  this.vel.limit(sliderVelocity.value());//limits the velocity to the value of the slider
